...
const thirpartyGeos = readNDJSON('./build/tmp_thirdparty.json')
  .concat([
    JSON.parse(fs.readFileSync('./third_party_maps/DK-DK2-without-BHM.json')),
    JSON.parse(fs.readFileSync('./third_party_maps/NO-NO1.json')),
    JSON.parse(fs.readFileSync('./third_party_maps/NO-NO2.json')),
    JSON.parse(fs.readFileSync('./third_party_maps/NO-NO3.json')),
    JSON.parse(fs.readFileSync('./third_party_maps/NO-NO4.json')),
    JSON.parse(fs.readFileSync('./third_party_maps/NO-NO5.json')),
    JSON.parse(fs.readFileSync('./third_party_maps/SE-SE1.json')),
    JSON.parse(fs.readFileSync('./third_party_maps/SE-SE2.json')),
    JSON.parse(fs.readFileSync('./third_party_maps/SE-SE3.json')),
    JSON.parse(fs.readFileSync('./third_party_maps/SE-SE4.json')),
    JSON.parse(fs.readFileSync('./third_party_maps/JP-CB.json')),
    JSON.parse(fs.readFileSync('./third_party_maps/JP-HR.json')),
    JSON.parse(fs.readFileSync('./third_party_maps/JP-KN.json')),
    JSON.parse(fs.readFileSync('./third_party_maps/JP-KY.json')),
    JSON.parse(fs.readFileSync('./third_party_maps/JP-ON.json')),
    JSON.parse(fs.readFileSync('./third_party_maps/JP-TK.json')),
    JSON.parse(fs.readFileSync('./third_party_maps/IT-CSO.geojson')),
    JSON.parse(fs.readFileSync('./third_party_maps/IT-NO.geojson')),
    JSON.parse(fs.readFileSync('./third_party_maps/IT-SAR.geojson')),
    JSON.parse(fs.readFileSync('./third_party_maps/IT-SIC.geojson')),
    JSON.parse(fs.readFileSync('./third_party_maps/IT-SO.geojson')),
    JSON.parse(fs.readFileSync('./third_party_maps/IT-CNO.geojson')),
  ]);
...
const zoneDefinitions = [
  ...
  { zoneName: 'IT-CNO', type: 'subZone', id: 'IT-CNO' },
  { zoneName: 'IT-CSO', type: 'subZone', id: 'IT-CSO' },
  { zoneName: 'IT-NO', type: 'subZone', id: 'IT-NO' },
  { zoneName: 'IT-SAR', type: 'subZone', id: 'IT-SAR' },
  { zoneName: 'IT-SIC', type: 'subZone', id: 'IT-SIC' },
  { zoneName: 'IT-SO', type: 'subZone', id: 'IT-SO' },
  //
